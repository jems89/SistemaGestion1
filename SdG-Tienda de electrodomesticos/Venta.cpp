...
bool Venta::leerDeDisco(int pos)
{
    ...
    {
        rlutil::cls();
        obj.Menurectangulo(49, 11, 25, 4, "");
        std::cout << "NO hay ventas Error al abrir.\n";
        system("pause");
        return 0;
    }
...
void Venta::cargar() {
    ...
    n=producto.BuscarProducto(codigoProducto);
    if (n > -1) {
        rlutil::locate(43, 33);
        rlutil::setBackgroundColor(rlutil::GREEN);
        std::cout << "producto encontrado ok ";
        rlutil::setBackgroundColor(rlutil::BLACK);
        ...
        std::cout << "NO EXISTE EL PRODUCTO ";
        rlutil::setBackgroundColor(rlutil::BLACK); cargar(); }
...
void Venta::listarVenta() {
    ...
    while (salir) {
        ...
        rlutil::setColor(rlutil::WHITE);
        rlutil::setBackgroundColor(rlutil::BLACK);
        obj.Menurectangulo(49, 8, 30, 3, "");
        std::cout << "1-Listar todas las ventas";
        obj.Menurectangulo(49, 11, 30, 3, "");
        std::cout << "2-Listar una venta";
        obj.Menurectangulo(49, 14, 30, 3, "");
        std::cout << "0-Volver" << std::endl << std::endl;
        obj.Menurectangulo(49, 17, 30, 3, "");
        std::cin >> opcion;
        rlutil::cls();
        switch (opcion)
        {
        case 1:
            ...
            std::cout << "NO HAY VEBTAS";
            break;
        case 2:
            obj.Menurectangulo(49, 8, 25, 4, "");
